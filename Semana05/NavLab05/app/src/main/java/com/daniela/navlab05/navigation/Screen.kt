package com.daniela.navlab05.navigation
...
sealed class Screen(val route: String) {
    ...
    // Pantalla de inicio - punto de entrada de la app[cite: 1]
    object Home : Screen(route = "home")

    // Pantalla que muestra la lista de elementos[cite: 1]
    object List : Screen(route = "list")

    // Pantalla del perfil del usuario[cite: 1]
    object Profile : Screen(route = "profile")

    // RUTA CON ARGUMENTO: {itemId} es el placeholder que Navigation reemplaza
    // con el valor real al momento de navegar[cite: 1]
